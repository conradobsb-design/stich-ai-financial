    ...
    <div className="mesh-bg relative min-h-screen flex items-center justify-center p-6 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-on-surface-variant/50 text-xs font-medium">ou continue com</span>
          <div className="flex-1 h-px bg-outline-variant" />
        </div>
        ...
        <motion.button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white/[0.06] hover:bg-white/[0.10] border border-outline-variant hover:border-white/20 py-3.5 rounded-2xl text-white text-sm font-semibold transition-all disabled:opacity-50"
        >
          <GoogleIcon />
          Entrar com Google
        </motion.button>
